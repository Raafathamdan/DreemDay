...
namespace DreemDay.Migrations
{
    ...
    [Migration("20240610223847_updateRealtion3")]
    partial class updateRealtion3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DreemDay_Core.Models.Entity.Category", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 1, 38, 47, 401, DateTimeKind.Local).AddTicks(2548));
            ...
            modelBuilder.Entity("DreemDay_Core.Models.Entity.Login", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 1, 38, 47, 401, DateTimeKind.Local).AddTicks(3444));
            ...
            modelBuilder.Entity("DreemDay_Core.Models.Entity.Order", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 1, 38, 47, 399, DateTimeKind.Local).AddTicks(5624));
            ...
            modelBuilder.Entity("DreemDay_Core.Models.Entity.Service", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 1, 38, 47, 401, DateTimeKind.Local).AddTicks(5182));
            ...
            modelBuilder.Entity("DreemDay_Core.Models.Entity.ServiceProvider", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 1, 38, 47, 401, DateTimeKind.Local).AddTicks(6379));
            ...
            modelBuilder.Entity("DreemDay_Core.Models.Entity.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 11, 1, 38, 47, 400, DateTimeKind.Local).AddTicks(130));
